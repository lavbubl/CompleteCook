...
var _cur_bind = variable_clone(global.bindslist[$ _bindname][1])
...
if binding 
{
	...
	{	
		...
		else
		{
			...
			if !array_contains(_cur_bind, _gamepad_button) //check if the key isnt set already
				array_push(_cur_bind, _gamepad_button) //then add the key
		}
